            ...
            for (let i = 0; i < rows.length; i += BATCH_SIZE) {
                ...
                for (const r of chunk) {
                    ...
                    params.push(
                        ...
                        r.LensColor ? String(r.LensColor).trim() : null,
                        r.LensLevel ? String(r.LensLevel).trim() : null,
                        ...
                        r.PicNum ? String(r.PicNum).trim() : null,
                        r.PCom ? String(r.PCom).trim() : null,
                        cleanNumber(r.Basis),
                        cleanNumber(r.Pent),
                        cleanNumber(r.VD),
                        now,
               ...
               "treatBlock", "treatWSec", "treatWScrew", "treatWNylon", "treatWKnife",
               "lensColor", "lensLevel",
